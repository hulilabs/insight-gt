    ...
    var TextField = Vue.extend({
        ...
        methods : {
            ...
            setValue : function(value, shouldTriggerState) {
                var isTrimmable = (InputTypesEnum.TEXT === this.type || InputTypesEnum.PASSWORD === this.type),
                    isString = 'string' === typeof value;

                this.state.value = (isTrimmable && isString && this.trim) ? value.trim() : value;
            ...
            _onChange : function(e) {
                ...
                // cancels input if a regex is passed as a pattern argument and it doesn't match the input
                ...
                if (this.isTypeNumber && !isNaN(maxLength)) {
                    return this.setValue(value.length >= maxLength ? value.slice(0, maxLength) : value);
                }
