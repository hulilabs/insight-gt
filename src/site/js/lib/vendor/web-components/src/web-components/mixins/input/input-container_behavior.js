 ...
 */
/**
 * @file InputContainerBehaviorMixin
 *
 * @description defines common properties for containers of inputs that may have the
 *              floating label behavior, addons and the focused border bottom animation
 *
...
define([], function() {
    ...
    var InputContainerBehaviorMixin = {
        props : {
            ...
            /**
             * Defines if the input should mark itself on error state using native validations
             * By default, inputs won't use Validity features (NOT supported in Safari)
             * The functionality check must be implemented on each component
