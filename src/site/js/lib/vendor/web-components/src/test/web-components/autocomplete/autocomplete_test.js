...
function(
    ...
    describe('Autocomplete', function() {
        ...
        context('on value set', function() {
            ...
            it('avoid debounce when not searching', function() {
                var autocomplete = vm.$refs.autocomplete;
                autocomplete._onInputDebounce('foobar');
                // the debounce function is now set.
                expect(autocomplete.state.debounce).to.be.null;
            });
        });
        ...
        context('on interacting with events of the input', function() {
            ...
            it('checks the on debounce event', function() {
                ...
                autocomplete._onInputDebounce('foobar');
                // the debounce function is now set.
                expect(autocomplete.state.debounce).to.be.an('Function');
            });
