...
function(
    ...
    var EVENT = {
        ...
        ON_TOGGLE : 'searchdropdown-toggle'
    };
    ...
    var SearchDropdown = Vue.extend({
        ...
        methods : {
            ...
            /**
             * Notifies when the box toggles
             * @param {boolean} toggle
             * @fires module:SearchDropdown#ON_TOGGLE
             */
            _onInputToggle : function(toggle) {
                this.$emit(EVENT.ON_TOGGLE, toggle);
            },
