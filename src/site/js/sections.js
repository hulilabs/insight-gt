...
define({
    ITEMS: [
        ...
        {
            url:
                'https://github.com/hulilabs/web-components/tree/master/src/web-components/behaviors/a11y/button-focus',
            name: 'Button focus',
        },
        { path: '/behaviors/floating-layer#sandbox', name: 'Floating layer Behavior' },
        {
            url:
                'https://github.com/hulilabs/web-components/tree/master/src/web-components/behaviors/a11y/keyboard-focus',
            name: 'Keyboard focus',
        },
        {
            url:
                'https://github.com/hulilabs/web-components/tree/master/src/web-components/behaviors/a11y/selection-control-focus',
            name: 'Selection control focus',
        },
        ...
        {
            url:
                'https://github.com/hulilabs/web-components/tree/master/src/web-components/mixins/input#input-behavior-mixin-documentation',
            name: 'Input Behavior',
        },
        {
            url:
                'https://github.com/hulilabs/web-components/tree/master/src/web-components/mixins/input#input-container-behavior-mixin-documentation',
            name: 'Input Container Behavior',
        },
