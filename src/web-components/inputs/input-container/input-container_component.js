 ...
 */
/**
 * @file Input container component that allows encapsulation of the floating label behavior,
...
function(
    ...
    var InputContainer = Vue.extend({
        ...
        computed : {
            ...
            /**
             * Checks if a non-empty content is given, for displaying a hint message.
             * The hint won't be displayed at the same time as an error message.
             * @return {boolean}
             */
            hasHint : function() {
                return this.hintText !== null && this.hintText.length > 0 && !this.hasError;
            },
            /**
